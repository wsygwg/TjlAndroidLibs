...
public class AlbumHelper {
    ...
    HashMap<String, ImageBucket> hissBucketList = new HashMap<String, ImageBucket>();
    ...
    void buildImagesBucketList() {
        ...
        if (cur.moveToFirst()) {
            ...
            do {
                ...
                Log.e(TAG, _id + ", bucketId: " + bucketId + ", picasaId: "
                        + picasaId + " name:" + name + " path:" + path
                        + " title: " + title + " size: " + size + " bucket: "
                        + bucketName + "---");

                ImageBucket bucket = hissBucketList.get(bucketId);
                if (bucket == null) {
                    bucket = new ImageBucket();
                    hissBucketList.put(bucketId, bucket);
        ...
        Iterator<Entry<String, ImageBucket>> itr = hissBucketList.entrySet().iterator();
        while (itr.hasNext()) {
        ...
        Log.e(TAG, "use time: " + (endTime - startTime) + " ms");
    }
