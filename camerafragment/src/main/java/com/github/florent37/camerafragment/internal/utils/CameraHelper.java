...
public final class CameraHelper {
    ...
    public static boolean hasCamera(Context context) {
        return context.getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA) || context.getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FRONT);
    }
    ...
    public static CamcorderProfile getCamcorderProfile(int currentCameraId, long maximumFileSize, int minimumDurationInSeconds) {
        ...
        int[] qualities = new int[]{Configuration.MEDIA_QUALITY_HIGHEST, Configuration.MEDIA_QUALITY_HIGH, Configuration.MEDIA_QUALITY_MEDIUM, Configuration.MEDIA_QUALITY_LOW, Configuration.MEDIA_QUALITY_LOWEST};
    ...
    public static CamcorderProfile getCamcorderProfile(@Configuration.MediaQuality int mediaQuality, int cameraId) {
        if (Build.VERSION.SDK_INT > 10) {
            if (mediaQuality == Configuration.MEDIA_QUALITY_HIGHEST) {
                ...
                //                    Log.e(TAG, "清晰度设置：Quality level corresponding to the cif (352 x 288) resolution.");
                ...
                //                    Log.e(TAG, "清晰度设置：Quality level corresponding to the QVGA (320x240) resolution.");
                //                    return CamcorderProfile.get(cameraId, CamcorderProfile.QUALITY_QVGA);
                //                } else if (CamcorderProfile.hasProfile(cameraId, CamcorderProfile.QUALITY_480P)) {
                //                    Log.e(TAG, "清晰度设置：Quality level corresponding to the 480p (720 x 480) resolution.");
                //                    return CamcorderProfile.get(cameraId, CamcorderProfile.QUALITY_QVGA);
                //                } else if (CamcorderProfile.hasProfile(cameraId, CamcorderProfile.QUALITY_QCIF)) {
                //                    Log.e(TAG, "清晰度设置：Quality level corresponding to the qcif (176 x 144) resolution.");
