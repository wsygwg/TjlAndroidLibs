...
public class ConfigurationProviderImpl implements ConfigurationProvider {
    ...
    protected int mediaQuality = Configuration.MEDIA_QUALITY_LOW;

    @Configuration.MediaQuality
    protected int passedMediaQuality = Configuration.MEDIA_QUALITY_LOW;
        ...
        if (configuration != null) {
            ...
            if (mediaQuality != -1) {
                switch (mediaQuality) {
                    ...
                    default:
//                        setMediaQuality(Configuration.MEDIA_QUALITY_MEDIUM);
                        if(getMediaAction() == Configuration.MEDIA_ACTION_PHOTO){
                            setMediaQuality(Configuration.MEDIA_QUALITY_MEDIUM);
                        }else{
                            setMediaQuality(Configuration.MEDIA_QUALITY_LOWEST);//将视频默认的中等清晰度改为最低清晰度
                        }
                        break;
                }
