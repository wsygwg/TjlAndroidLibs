...
public class HissTitleBar4ActionBar extends RelativeLayout {
    ...
    public HissTitleBar4ActionBar(Context context) {
        super(context);
    }

    public HissTitleBar4ActionBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        titleBarView = LayoutInflater.from(context).inflate(R.layout.include_main_titlebar4actionbar, this, true);
    ...
    public HissTitleBar4ActionBar(Context context, AttributeSet attrs, int defStyleAttr) {
