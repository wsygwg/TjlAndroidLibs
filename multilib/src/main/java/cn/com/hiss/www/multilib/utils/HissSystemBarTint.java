...
public class HissSystemBarTint {

    /**
     * 设置状态栏颜色 * * @param activity 需要设置的activity * @param color 状态栏颜色值
     */
    public static void setColor(FragmentActivity activity, int color) {
     ...
     */
    private static View createStatusView(FragmentActivity activity, int color) {
        // 获得状态栏高度
