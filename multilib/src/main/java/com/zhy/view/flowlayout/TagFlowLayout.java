...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    private static final int FLOW_LAYOUT_MARGIN = 1;
    ...
    private void changeAdapter() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tagView.getLayoutParams() != null) {
                ...
                lp.setMargins(dip2px(getContext(), FLOW_LAYOUT_MARGIN), dip2px(getContext(), FLOW_LAYOUT_MARGIN), dip2px(getContext(), FLOW_LAYOUT_MARGIN), dip2px(getContext(), FLOW_LAYOUT_MARGIN));
